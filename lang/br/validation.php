...
return [
    ...
    */
    ...
    'password' => [
        'letters' => 'O campo :attribute precisa conter ao menos uma letra.',
        'mixed' => 'O campo :attribute precisa conter ao menos uma letra maiúscula e uma letra minúscula.',
        'numbers' => 'O campo :attribute precisa conter ao menos um número.',
        'symbols' => 'O campo :attribute precisa conter ao menos um símbolo.',
        'uncompromised' => 'O valor informado no campo :attribute apareceu em um vazamento de dados. Por favor, informe um valor diferente.',
    ],
